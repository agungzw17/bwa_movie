...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
          BlocProvider.of<PageBloc>(context).add(GoToSelectSeatPage(widget.ticket));
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      BlocBuilder<UserBloc, UserState>(
                        builder: (_, userState) {
                          UserModel user = (userState as UserLoaded).userModel;
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            image: NetworkImage(imageBaseURL +
                                                '/w342/' +
                                                "${widget.ticket.movieDetailModel
                                                    .posterPath}"),
                                            fit: BoxFit.cover)),
                                  ),
                                  Column(
                                    ...
                                    children: <Widget>[
                                      SizedBox(
                                          width: MediaQuery.of(context)
                                              ...
                                              20,
                                          child: Text(
                                            widget.ticket.movieDetailModel.title ?? '',
                                      ...
                                      RatingStars(
                                        voteAverage: widget
                                            .ticket.movieDetailModel.voteAvarage ?? 0.0,
                                        color: accentColor3,
                                      )
                                    ],
                                  )
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                      width: MediaQuery.of(context).size.width *
                                          0.55,
                                      child: Text(
                                        widget.ticket.theaterModel.name,
                                ...
                                child: RaisedButton(
                                    ...
                                    onPressed: () {
                                      if (user.balance! >= total) {
                                        FlutixTransactionModel transaction =
                                        FlutixTransactionModel(
                                            userID: user.id,
                                            title: widget
                                                .ticket.movieDetailModel.title,
                                            subtitle:
                                            widget.ticket.theaterModel.name,
                                            time: DateTime.now(),
                                            amount: -total,
                                        ...
                                        BlocProvider.of<PageBloc>(context).add(GoToSuccessPage(
